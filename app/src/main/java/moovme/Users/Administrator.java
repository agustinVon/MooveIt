...
public class Administrator extends Operators {
    ...
    public void registerAdmin(Repository<com.spacetech.moovme.Users.Administrator> repositoryAdmins, Data data) throws ElementExistException {
        repositoryAdmins.add(new com.spacetech.moovme.Users.Administrator(data));
    }
    ...
    public boolean equals(Object object){
        if(object instanceof com.spacetech.moovme.Users.Administrator){
            return ((com.spacetech.moovme.Users.Administrator) object).getName().equals(data.getName());
        }
        else return false;
    }
