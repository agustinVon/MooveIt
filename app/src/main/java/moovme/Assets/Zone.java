...
import com.spacetech.moovme.Assets.Tarifario;
...
public class Zone {
    ...
    public boolean equals(Object object){
        if(object instanceof com.spacetech.moovme.Assets.Zone){
            return ((com.spacetech.moovme.Assets.Zone) object).getName().equals(name);
        }
        else return false;
    }
