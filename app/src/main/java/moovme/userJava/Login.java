...
import com.spacetech.moovme.userJava.menu_user;
        ...
        btn_login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    Intent i = new Intent(com.spacetech.moovme.userJava.Login.this, menu_user.class);
                    i.putExtra("phonenumber",phonenumber);
                    startActivity(i);

                } catch (UserDoesntExistException e) {
                    DialogException.CreateDialog("Error user login","User doesnt exist", com.spacetech.moovme.userJava.Login.this);
                }
                /*
